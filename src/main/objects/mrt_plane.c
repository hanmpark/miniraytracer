...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/05 01:57:20 by hanmpark          #+#    #+#             */
/*   Updated: 2024/03/07 12:42:09 by hanmpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "mrt_render.h"

static void	hit_surface_normal(t_hit *hit, t_fvec3 incident_ray, t_obj *o)
{
	t_fvec3	obj_normal;

	hit->pos = mult_mat4x4_fvec3(incident_ray, o->fmat4x4[FORWARD]);
